...
model_folder="co-my/model.s2s.comy";
mkdir -p ${model_folder};
data_path="/home/ye/exp/nmt/cv-predict/data/co/co-my";
src="co"; tgt="sy";
...
marian \
  ...
  --dump-config > ${model_folder}/co-my.config.yml

time marian -c ${model_folder}/co-my.config.yml  2>&1 | tee ${model_folder}/s2s.${src}-${tgt}.log
